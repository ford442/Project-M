...
private:
	...
	/** Identifier of the vertex chain (the vertices used for display of the album cover artwork
	 * texture). */
	 ...
	 * @remarks The dimension of the stage box has to take into account the rotation and screen
	 * constraints. On front view the rotating bitmap should have the same dimensions on screen as in
	 * 2-D world but available canvas space must not be exceeded.
	 */
