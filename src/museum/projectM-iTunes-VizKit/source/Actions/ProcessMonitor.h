...
public:
	 ...
	 * @param elapsedAudioTime The elapsed time of the current track in milliseconds. 0 if no time
	 * value is available.
	 * @param remainingAudioTime The remaining time of the current track in milliseconds. 0 if no time
	 * value is available.
	 */
	...
	/**
	 * Updates the vertices of the components of the trackProgressMeter (e.g. after a reshape of the
	 * canvas).
	 */
...
private:
	 ...
	 */
	void calcTrackProgressMeterVertices(
