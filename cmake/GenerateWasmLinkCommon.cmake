...
list(JOIN PROJECTM_WASM_EXCEPTION_ARGS " " _exception_args)
...
projectm_wasm_common_link_args() {
    ...
    local exception_args=(${_exception_args})
...
// pooled Workers.
constexpr int kWasmOpenMpThreads = ${PROJECTM_WASM_OPENMP_THREADS};

// Preset prepare threads, one per WasmHost (WasmPresetPrepare.cpp).
constexpr int kWasmPresetPrepareThreads = ${PROJECTM_WASM_PRESET_PREPARE_THREADS};
