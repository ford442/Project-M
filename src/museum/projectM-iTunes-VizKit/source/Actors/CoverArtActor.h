...
/**
 * A visual representation of the album cover art data included with the audio track. The cover
 * rotates slowly around the y-axis. iTunes can handle embedded cover art data. The CoverArtActor is
 * responsible for displaying cover art data if there exists any with the current track. The visual
 * representation of the cover art data is created as a texture. The texture of the cover art can be
 * manipulated in various ways. The rotation is a basic example for simplicity's sake.
 */
