...
/**
 * Collection of QuickTime functionality. Access of QuickTime functionality is restricted to this
 * class.
 */
...
private:
	/** The constructor. VisualQuickTime is a collection of static methods. Class does not need any
	 * instances. Constructor is private and not implemented. */
	VisualQuickTime();

	/** The destructor. VisualQuickTime is a collection of static methods. Class does not need any
