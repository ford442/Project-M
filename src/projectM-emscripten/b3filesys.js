...
document.getElementById("canvas").style="position:absolute;z-index:999995;";
document.getElementById("vcanvas").style="position:absolute;z-index:999994;";
  document.getElementById("canvas").height=hhh;
  document.getElementById("vcanvas").height=hhh;
  document.getElementById("canvas").width=www;
  document.getElementById("vcanvas").width=www;
document.getElementById('ihig').innerHTML=hhh;
