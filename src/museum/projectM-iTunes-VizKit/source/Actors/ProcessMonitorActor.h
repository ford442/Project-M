...
/**
 * This actor displays textual and graphical information useful for debugging, diagnostics and
 * monitoring purposes. Visual plug-ins can be debugged by writing output to stdout. If it is
 * neccessary to monitor reoccuring and changing data in realtime the data can be registered with
 * the ProcessMonitorActor and refreshed with each render call. The registered output is displayed
 * on screen.
 */
...
public:
	 ...
	 */
	void registerProcessMonitorInfoMap(
