...
// initialisers.
// =============================================================================
// Idle release policy for the Preset A pair lives on WasmHost
// (dualFboIdleReleaseSec, default 5 s). Preset A is crossfade scratch only:
// between transitions render_frame() takes the direct-to-canvas path and never
// samples it. Holding the pair resident for a whole session costs ~14 MB at
// 1280x720 RGBA16F (~31 MB at 1920x1080) of VRAM that nothing reads.
// render_frame() reclaims it once that many seconds have passed since the last
// transition ended.
//
