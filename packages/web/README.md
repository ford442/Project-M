...
> audio and framerate regressions were fixed in 037, but the promotion run to make
> a newer tag the host default has not happened yet. If you need the older bundle, `--version 032` fetches it — it
