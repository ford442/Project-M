...
parent.document.getElementById("ihig").innerHTML=window.innerHeight;
...
parent.document.getElementById("dis").click();
});
parent.document.getElementById('btn2').addEventListener('click',function(){
