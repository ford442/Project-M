...
public:
	 ...
	 * @param callbackAfterThreadDidDie Callback that is called after the created thread did finished
	 * execution.
	 * @return True on success, false on failure.
	 */
	static bool createThread(ThreadingFuncPtr aThreadingFuncPtr, void *param = NULL,
		ThreadDidDieCallback callbackAfterThreadDidDie = NULL);

private:
	/** The constructor. VisualThreading is a collection of static methods. Class does not need any
	 * instances. Constructor is private and not implemented. */
	VisualThreading();

	/** The destructor. VisualThreading is a collection of static methods. Class does not need any
