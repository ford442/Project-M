...
void TrackTitleActor::handleNotification(VisualNotification &aNotification)
{
	...
	switch (notificationKey)
	{
		...
		case kAudioPlayPausedEvt: this->trackTitle->pulsate(); break;
		...
		default: writeLog("unhandled Notification in TrackTitleActor"); break;
	}
}
