...
bool VisualAudioMetaData::operator==(const VisualAudioMetaData &other)
{
	...
	if ((this->trackSizeInBytes == other.trackSizeInBytes) && (this->trackName == other.trackName)
			&& (this->trackArtist == other.trackArtist) && (this->trackAlbum == other.trackAlbum)
			&& (this->isStream == other.isStream) && (this->streamTitle == other.streamTitle))
	{
		compareResult = true;
	}
