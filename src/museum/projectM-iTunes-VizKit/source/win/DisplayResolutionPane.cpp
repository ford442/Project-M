...
void CDisplayResolutionPane::OnSelchangeCombo1()
{
	...
	UInt16 bitsPerPixel;
	UInt16 refreshRate;
	theVisualGraphics->matchDisplayResolutionShowStrWithPrefs(
		str, horizontalPixels, verticalPixels, bitsPerPixel, refreshRate);
	...
	VisualDataStore::setPreferenceValueInt(
		VisualConfiguration::kFullscreenBitsPerPixel, bitsPerPixel);
	...
	VisualDataStore::setPreferredDisplayResolution(
