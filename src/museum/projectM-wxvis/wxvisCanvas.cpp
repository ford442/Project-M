...
wxvisCanvas::wxvisCanvas(wxFrame *parent, const wxWindowID id, const wxPoint &pos,
	const wxSize &dims, long style, const wxString &name)
		: wxGLCanvas(parent, (wxGLCanvas *)NULL, id, pos, dims, style, name)
{
...
#ifdef WIN32
	refreshSemaphore = CreateSemaphore(NULL, 1, 1, "Redraw Semaphore");
