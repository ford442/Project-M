...
document.getElementById("canvas").style="position:absolute;left:0px;top:0px;background-color:rgba(1,1,1,0);z-index:999995;image-rendering:pixelated;width:1440px;height:1440px;";
