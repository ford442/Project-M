...
public:
	 ...
	 */
	void processAudioData(uint8 numWaveformChannels, uint16 numWaveformEntries,
	 ...
	 * @param totalTimeInMS The total time of the currently playing audio track measured in
	 * milliseconds.
	 */
	 ...
	 * @param startTimeInMS The start time of the currently playing audio track measured in
	 * milliseconds.
	 */
	 ...
	 * @param stopTimeInMS The stop time of the currently playing audio track measured in
	 * milliseconds.
	 */
	 ...
	 */
	uint8 getWaveformDataOfChannelAtIndexWithHistoryNum(
...
private:
	/** The constructor. VisualAudioLab is a singleton class. The constructor is private. New instance
	 * of class can only be created internally. */
	VisualAudioLab();

	/** The destructor. VisualAudioLab is a singleton class. The destructor is private. Instance of
	 * class can only be destructed internally. */
	~VisualAudioLab();

	/**
	 * Copy constructor.
	 * @param other Another VisualAudioLab.
	 * @remarks Explicitely declared in private section and not implemented to enforce uniqueness of
	 * singleton pattern.
	 */
	 ...
	 */
	void processSpectrumData(const uint8 numSpectrumChannels, const uint16 numSpectrumEntries,
		const uint8 *const currSpectrumData);
	...
	/** The start time of the currently playing audio track measured in milliseconds. iTunes allows to
	 * set a custom start time for a track. */
	uint32 startTimeOfTrack;

	/** The stop time of the currently playing audio track measured in milliseconds. iTunes allows to
	 * set a custom stop time for a track. */
	 ...
	 */
	// sint8
	// waveformData[maxNumberOfMusicDataHistory][kVisualMaxDataChannels][kVisualNumWaveformEntries];
	sint8 ***waveformData;
	 ...
	 */
	// uint8
	// spectrumData[maxNumberOfMusicDataHistory][kVisualMaxDataChannels][kVisualNumSpectrumEntries];
	uint8 ***spectrumData;
	 ...
	 * Must be greater than: Audio sample rate (44100) / kVisualNumWaveformEntries *
	 * (numberOfMillisecondsOfRMSBuffer / 1000).
	 */
	...
	typedef struct
	{
		...
		uint32 timeInMillisecondsSinceStartOfTrack; /**< The number of milliseconds elapsed since start
																									 of audio track. */
	} RMSValue;

	/**
	 * Array containg rms mono values for the last numberOfMillisecondsOfRMSBuffer milliseconds.
	 * Ringbuffer. RMSValues with ((currentMSSinceStartOfTrack - timeInMillisecondsSinceStartOfTrack)
	 * > numberOfMillisecondsOfRMSBuffer) are discarded.
	 */
	...
	/** Array in which the detected beats are stored with their elapsed milliseconds timestamp since
	 * start of track. Ringbuffer. */
	...
	/**
	 *
	 * @param elapsedMSSinceStartOfTrack The number of milliseconds elapsed since start of audio
	 * track.
