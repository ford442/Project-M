...
/**
 * Provides facilities to deal with and calculate time values. All public methods are declared
 * static.
 */
class VisualTiming
{
...
public:
	 ...
	 * @return The number of milliseconds that have elapsed since the last call.
	 */
	static uint32 getElapsedMilliSecsSinceLastCall(
	 ...
	 * The date and time are represented as YYYYMMDDHHMISS000
...
private:
	...
	/** The constructor. VisualTiming is a singleton class. The constructor is private. New instance
