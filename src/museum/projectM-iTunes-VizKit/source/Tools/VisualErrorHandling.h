...
extern "C"
{
	...
	/**
	 * Writes a 8-bit string to the system log file or a log file on the Desktop. By setting internal
	 * variable textFile, the behavior of this function can be customized.
	 * @param infoStr The 8-bit string to write to log file.
	 * @remarks In case of crash stop of iTunes on Mac, the system log messages sometimes are not
	 * written completely to the system log file because the flushing of the remaining string data
	 * does not occur.
	 */
