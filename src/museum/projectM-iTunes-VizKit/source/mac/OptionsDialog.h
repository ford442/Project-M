...
/**
 * UI (Mac): Shows a configuration dialog when selecting visualizer and choosing Options... menu
 * entry in iTunes.
 */
class OptionsDialog
{
...
private:
	/** The constructor. OptionsDialog is a singleton class. The constructor is private. New instance
	 * of class can only be created internally. */
	OptionsDialog();

	/** The destructor. OptionsDialog is a singleton class. The destructor is private. Instance of
	 ...
	 */
	static OSStatus optionsDialogControlHandler(
	 ...
	 * @param userData Optional additional user data.
	 */
	static OSStatus optionsDialogWindowHandler(
		EventHandlerCallRef inRef, EventRef inEvent, void *userData);
