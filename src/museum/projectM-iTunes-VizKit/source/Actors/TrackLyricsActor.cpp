...
void TrackLyricsActor::handleNotification(VisualNotification &aNotification)
{
	...
	switch (notificationKey)
	{
		...
		case kTrackLyricsImageMsg:
		{
			...
			// VisualDataStore::setValue(VisualDataStore::kTrackInfoTextureHeight,
			// this->trackTitle->getTrackInfoTextureHeightInPixels());
		...
		default: writeLog("unhandled Notification in TrackLyricsActor"); break;
	}
}
