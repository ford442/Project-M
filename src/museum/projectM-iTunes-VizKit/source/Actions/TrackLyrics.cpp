...
VisualStringStyle TrackLyrics::getTrackLyricsStringStyle()
{
	...
	stringStyle.fontSize =
		(float)(VisualPreferences::getValue(VisualPreferences::kTrackLyricsFontSize));

	stringStyle.fontColor.r =
		VisualPreferences::getValue(VisualPreferences::kTrackLyricsFontColorRedFloat);
	stringStyle.fontColor.g =
		VisualPreferences::getValue(VisualPreferences::kTrackLyricsFontColorGreenFloat);
	stringStyle.fontColor.b =
		VisualPreferences::getValue(VisualPreferences::kTrackLyricsFontColorBlueFloat);
...
void TrackLyrics::reshape()
{
	...
	trackLyricsAssetPosition.minMarginBottom =
		(double)VisualDataStore::getValueInt(VisualDataStore::kTrackInfoTextureHeight) + 5.0;
	...
	for (uint8 i = 0; i < 4; i++)
	{
		switch (i)
		{
			case 0:
				aVertexColor.r =
					VisualPreferences::getValue(VisualPreferences::kTrackLyricsTextureColorTopLeftRed);
				aVertexColor.g =
					VisualPreferences::getValue(VisualPreferences::kTrackLyricsTextureColorTopLeftGreen);
				aVertexColor.b =
					VisualPreferences::getValue(VisualPreferences::kTrackLyricsTextureColorTopLeftBlue);
				aVertexColor.a =
					VisualPreferences::getValue(VisualPreferences::kTrackLyricsTextureColorTopLeftAlpha);
			...
			case 1:
				aVertexColor.r =
					VisualPreferences::getValue(VisualPreferences::kTrackLyricsTextureColorBottomLeftRed);
				aVertexColor.g =
					VisualPreferences::getValue(VisualPreferences::kTrackLyricsTextureColorBottomLeftGreen);
				aVertexColor.b =
					VisualPreferences::getValue(VisualPreferences::kTrackLyricsTextureColorBottomLeftBlue);
				aVertexColor.a =
					VisualPreferences::getValue(VisualPreferences::kTrackLyricsTextureColorBottomLeftAlpha);
				aVertexColor.red = aVertexColor.r;
				aVertexColor.green = aVertexColor.g;
				aVertexColor.blue = aVertexColor.b;
				aVertexColor.alpha = aVertexColor.a;
			...
			case 2:
				aVertexColor.r =
					VisualPreferences::getValue(VisualPreferences::kTrackLyricsTextureColorBottomRightRed);
				aVertexColor.g =
					VisualPreferences::getValue(VisualPreferences::kTrackLyricsTextureColorBottomRightGreen);
				aVertexColor.b =
					VisualPreferences::getValue(VisualPreferences::kTrackLyricsTextureColorBottomRightBlue);
				aVertexColor.a =
					VisualPreferences::getValue(VisualPreferences::kTrackLyricsTextureColorBottomRightAlpha);
				aVertexColor.red = aVertexColor.r;
				aVertexColor.green = aVertexColor.g;
				aVertexColor.blue = aVertexColor.b;
				aVertexColor.alpha = aVertexColor.a;
			...
			case 3:
				aVertexColor.r =
					VisualPreferences::getValue(VisualPreferences::kTrackLyricsTextureColorTopRightRed);
				aVertexColor.g =
					VisualPreferences::getValue(VisualPreferences::kTrackLyricsTextureColorTopRightGreen);
				aVertexColor.b =
					VisualPreferences::getValue(VisualPreferences::kTrackLyricsTextureColorTopRightBlue);
				aVertexColor.a =
					VisualPreferences::getValue(VisualPreferences::kTrackLyricsTextureColorTopRightAlpha);
				aVertexColor.red = aVertexColor.r;
				aVertexColor.green = aVertexColor.g;
				aVertexColor.blue = aVertexColor.b;
				aVertexColor.alpha = aVertexColor.a;
	...
	sprintf(trackLyricsLayoutPos, "trackLyrics top: %f, left: %f, bottom: %f, right: %f",
		trackLyricsAssetBox->getTopCoord(), trackLyricsAssetBox->getLeftCoord(),
