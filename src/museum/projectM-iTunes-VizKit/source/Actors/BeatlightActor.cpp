...
void BeatlightActor::handleNotification(VisualNotification &aNotification)
{
	...
	switch (notificationKey)
	{
		...
		case kBeatImpulseEvt: this->beatlight->applyBehavior(); break;
		/*
		...
		case kAudioPlayPausedEvt:
			this->coverArt->fadeOut(VisualPreferences::getValue(VisualPreferences::kFadeOutTimeOnPauseInMS),
		0.15f); break;
		...
		case kAudioPlayResumedEvt:
			...
			break;
		*/
		case kCanvasReshapeEvt: this->beatlight->reshape(); break;
