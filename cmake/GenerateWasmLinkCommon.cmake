...
foreach(_entry IN LISTS PROJECTM_WASM_API_MANIFEST)
    ...
    if(_binding STREQUAL "ccall")
        ...
        if(_returns STREQUAL "void")
            set(_fn_body "    module.ccall('${_name}', ${_ccall_ret}, [${_ccall_types_ts}], [${_call_args_ts}]);\n")
        else()
            set(_fn_body "    return module.ccall('${_name}', ${_ccall_ret}, [${_ccall_types_ts}], [${_call_args_ts}]);\n")
        endif()
    else()
        if(_returns STREQUAL "boolean")
            if(_direct_call_args_ts STREQUAL "")
                set(_fn_body "    return !!module._${_name}();\n")
            else()
                set(_fn_body "    return !!module._${_name}(${_direct_call_args_ts});\n")
            endif()
        elseif(_returns STREQUAL "void")
            if(_direct_call_args_ts STREQUAL "")
                set(_fn_body "    module._${_name}();\n")
            else()
                set(_fn_body "    module._${_name}(${_direct_call_args_ts});\n")
            endif()
        else()
            if(_direct_call_args_ts STREQUAL "")
                set(_fn_body "    return module._${_name}();\n")
    ...
    string(APPEND _ts_wrappers "${_fn_body}}\n")
    ...
    string(APPEND _js_wrappers ") {\n")
    string(APPEND _js_wrappers "${_fn_body}}\n")
