...
var decrFac=bytePadding>0?bytePadding/sampleBytes:0;
for(var i=recBuffers.length-1; i>=0; --i){
...
let msgr={data:new Uint8Array(dataView.buffer)};
fll.postMessage(msgr);
}
...
// return false;
// }
// var view=new DataView(ui8_data.buffer); if((view.getUint8(offset) & 127 /* 0x7F */) != 0){ console.error("ERROR: wrong format for flac-file."); return false; }
return true;
}
